...
const DashboardStats = () => {
  ...
  return (
    <div className="space-y-6 bg-gray-50 dark:bg-gray-900 p-4 min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-green-800 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Total Peritos</p>
              <p className="text-2xl font-bold text-green-800 dark:text-green-400">{stats.totalPeritos}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-green-600 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-300">Secciones Activas</p>
              <p className="text-2xl font-bold text-green-600 dark:text-green-300">{stats.peritosPorSeccion.length}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-yellow-400 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-yellow-400 dark:text-yellow-300">{stats.peritosPorGrado.length}</p>
            </div>
            <div className="text-3xl text-yellow-400 dark:text-yellow-300">a</div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border-l-4 border-green-500 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-500 dark:text-green-300">algo</p>
            </div>
      ...
      {/* Quick Actions */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
        <h2 className="text-xl font-semibold text-green-800 dark:text-green-400 mb-4">Acciones Rápidas</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Peritos por Sección */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
          <h2 className="text-xl font-semibold text-green-800 dark:text-green-400 mb-4">Peritos por Sección</h2>
            ...
            <div className="space-y-3">
              {stats.peritosPorSeccion.map((seccion, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors duration-300">
                  <span className="font-medium text-gray-700 dark:text-gray-300">{seccion.Seccion}</span>
                  <span className="text-lg font-bold text-green-800 dark:text-green-400">{seccion.count}</span>
                </div>
              ))}
            </div>
          ) : (
            <p className="text-gray-500 dark:text-gray-400 text-center py-4">No hay datos de secciones disponibles</p>
          )}
        </div>

        {/* Peritos por Grado */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
          <h2 className="text-xl font-semibold text-green-800 dark:text-green-400 mb-4">Peritos por Grado</h2>
          {stats.peritosPorGrado.length > 0 ? (
            <div className="space-y-3">
              {stats.peritosPorGrado.map((grado, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors duration-300">
                  <span className="font-medium text-gray-700 dark:text-gray-300">{grado.Grado}</span>
                  <span className="text-lg font-bold text-green-800 dark:text-green-400">{grado.count}</span>
                </div>
              ))}
            </div>
          ) : (
            <p className="text-gray-500 dark:text-gray-400 text-center py-4">No hay datos de grados disponibles</p>
          )}
        </div>
      </div>
      ...
      {/* Recent Activity */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-300">
        <h2 className="text-xl font-semibold text-green-800 dark:text-green-400 mb-4">Actividad Reciente</h2>
        <div className="space-y-3">
